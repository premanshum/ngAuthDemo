...
(function (Msal) {
    ...
    AadAuthority.AadInstanceDiscoveryEndpoint = "https://login.microsoftonline.com/4b2c4934-c007-47dc-bff3-47eadcfa720a/discovery/instance";
...
(function (Msal) {
    var Constants = (function () {
        ...
        // Prem added
        Object.defineProperty(Constants, "code", {
...
(function (Msal) {
    var User = (function () {
        ...
        User.createUser = (preferredName, name, issuer, userIdentifier)=>{
            return new User(preferredName, name, issuer, userIdentifier);
        }
        return User;
    }());
    Msal.User = User;
...
(function (Msal) {
    ...
    var UserAgentApplication = (function () {
        function UserAgentApplication(clientId, authority, tokenReceivedCallback, validateAuthority) {
            ...
            this.authority = authority ? authority : "https://login.microsoftonline.com/4b2c4934-c007-47dc-bff3-47eadcfa720a";
        ...
        UserAgentApplication.prototype.loginPopup = function (scopes, extraQueryParameters) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.authorityInstance.ResolveEndpointsAsync().then(function () {
                    var authenticationRequest = new Msal.AuthenticationRequestParameters(
        ...
        UserAgentApplication.prototype.openWindow = function (
            ...
            reject) {
            var _this = this;
            var popupWindow = this.openPopup(urlNavigate, 
                title, Msal.Constants.popUpWidth, Msal.Constants.popUpHeight);
        ...
        UserAgentApplication.prototype.getUser = function () {
            ...
            var rawCode = this._cacheStorage.getItem(Msal.Constants.code);
            var clientInfo = new Msal.ClientInfo(rawClientInfo);
            if(!Msal.Utils.isEmpty(rawCode) && !Msal.Utils.isEmpty(rawClientInfo)) {
                this._user = Msal.User.createUser(
                    rawCode,            // displayableId
                    JSON.stringify( clientInfo),      // name
                    this.authority,     // identityProvider
                    'Nothing'
                );
                return this._user;
            }
        ...
        function (hash, resolve, reject) {
            ...
            if (this.isCallback(hash)) {
                ...
                //alert("RequestInfo :" + JSON.stringify( requestInfo) );
                ...
                if ((requestInfo.requestType === Msal.Constants.renewToken) && window.parent) {
                    ...
                    tokenReceivedCallback = this._tokenReceivedCallback;
                    token = requestInfo.parameters[Msal.Constants.code];
                    tokenType = Msal.Constants.code;
                }
                try {
        ...
        UserAgentApplication.prototype.saveTokenFromHash = function (tokenResponse) {
            ...
            if (tokenResponse.parameters.hasOwnProperty(Msal.Constants.errorDescription) || tokenResponse.parameters.hasOwnProperty(Msal.Constants.error)) {
                ...
                if (tokenResponse.stateMatch) {
                    ...
                    // Prem added
                    // in case of code
                    if(tokenResponse.parameters.hasOwnProperty(Msal.Constants.code)){      
                        if (tokenResponse.parameters.hasOwnProperty(Msal.Constants.clientInfo)) {
                            //alert(JSON.stringify(tokenResponse));
                            clientInfo = tokenResponse.parameters[Msal.Constants.clientInfo];
                        }
                        this._cacheStorage.setItem(Msal.Constants.code, tokenResponse.parameters[Msal.Constants.code]);
                        this._cacheStorage.setItem(Msal.Constants.clientInfo, clientInfo);
                    }
                }
                else {
        ...
        UserAgentApplication.prototype.isCallback = function (hash) {
            ...
            //alert("Is Code Present:" + parameters.hasOwnProperty(Msal.Constants.code));
            return (parameters.hasOwnProperty(Msal.Constants.errorDescription) ||
                ...
                parameters.hasOwnProperty(Msal.Constants.code));
        };
...
UserAgentApplication.prototype.getLogInfo = function () {
    alert("GetInfo");
};